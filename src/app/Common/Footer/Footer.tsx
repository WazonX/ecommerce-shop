...
export default function Navbar() {
  return (
    <div className="font-[quantico] grid grid-cols-4 @container border-t-[0.5px] py-5 border-zinc-500 w-3/4 mx-auto ">
      <div className="mx-auto my-auto">
        <span className="font-[kumar] cursor-default text-5xl items-center">
          SSW <br /> Store
        </span>
      </div>
      <div>
        <ul className="leading-7 text-center">
          <li className="text-2xl cursor-default pb-4">Links</li>
          <li>
      ...
      <div className="text-center">
        ...
        <ul>
          ...
          <li>
            ...
            <a href="tel:+48513203843" className="hover:underline">
              513203843
            </a>
          </li>
          <li>
            ...
            <a href="mailto:s33464@pjwstk.edu.pl" className="hover:underline">
